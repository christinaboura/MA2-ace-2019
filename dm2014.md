...
2. Comme le nom l'indique, un LFSR est une fonction linéaire de ses
   ...
   et qui renvoie $$(x_i,\dots,x_{n-1+i})$$. Il est conseillé de
   consulter la
...
1. Soit $$x_0,x_1\dots$$ la suite générée par le LFSR, et soit $$S$$
...
où $$(s_0,\dots,s_{15})$$ est une clef secrète de 16 bits.

1. Écrire une fonction qui prend en entrée
   
   - la clef secrète ($$s_0,\dots,s_{15}$$),
   - un entier $$i$$,
...
2. On considère l'anneau de polynômes $$𝔽_2[x_0,\dots,x_{n-1}]$$. Quel
   est l'idéal de la variété $$V=𝔽_2^n$$ ?

3. Modéliser les bits secrets $$(s_0,\dots,s_{15})$$ par autant de
