...
Soit $$n$$ un entier, pour $$1 ≤ i ≤ n$$ on définit les polynômes de
$$ℚ[x_1,\ldots,x_n]$$
...
Hillar et Windfeldt ont donner un critère pour détecter qu'un graphe
