...
1. Calculer un générateur $$g$$ pour l'idéal $$I_P ∩ ℚ[x]$$.
...
4. Prouver que pour tout polynôme $$P$$ la variété $$V(I_P ∩ ℚ[x])$$
   est de dimension zéro et coincide avec les racines de $$P$$ dans
   $$\F_{13^4}$$.

5. Calculer des générateurs des idéaux $$I_P∩ℚ[y_1]$$, $$I_P∩ℚ[y_2]$$
   et $$I_P∩ℚ[y_3]$$.
...
> 
> 2. Calculer $$V_{n-1} = V(I_P∩ℚ[y_{n-1}])$$ par recherche exaustive dans $$\F_p$$.
> 
